...
class Ref_Pit_Controller extends Admin_Template_Controller {
    ...
    public function listdata() {
       ...
       $draw=$_REQUEST['draw'];
        ...
        $list_qry=$db->select("SQL_CALC_FOUND_ROWS pit.id,contractor_id,p.name,p.alias,block_name,koordinat,area,state","lokasi_pit pit
        left join partner p on p.id=pit.contractor_id")
