...
class List_Crossmining_Controller extends Admin_Template_Controller {
    ...
    public function listdata() {
       ...
       // echo "<pre>";print_r($search);echo "</pre>";
        ...
        $keriteria[]="tod.tujuan_pengangkutan='BRG'";
         if( trim($tahun)<>"" ){   //name
		...
		*/
        ...
        // if(trim($tahun)<>"" and trim($bulan)<>""){
            ...
            received_time,ritase,quantity,dome_id","daily_transit_ore_detail tod
