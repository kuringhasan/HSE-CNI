          ...
          <div class="box box-primary">
            ...
            <div class="box-body" >
               ...
               <tr>
               		<td>Lokasi PIT</td>
                    <td>:</td>
                    <td><?php echo $detail->pit_name;?></td>
               </tr>
                <tr>
               		<td>Tujuan</td>
                    <td>:</td>
    ...
    <table border="1" class="table table-bordered bordered child" style="border-collapse:collapse;width:95%;" >
                            <tr style="border-top:1px">
                                ...
                                <th style="width:120px;">Qty.</th>
                                 <th style="width:120px;">Tujuan Pengangkutan</th>
                                  <th style="width:120px;">Dome</th>
                            </tr>
                   ...
                   ?>
                    <tr>
                                ...
                                <input type="text" name="qty[]" id="value-qty<?php echo $value->id;?>" value="<?php echo $value->quantity;?>"  style="display:none;width:100%;text-align:center"/>
                                 ...
                                 <td style="text-align:left;"><?php echo $value->tujuan_pengangkutan;?></td>
                                  <td style="text-align:left;"><?php echo $value->dome_name;?></td>
                            </tr>
                      <?php
                    $no++;
