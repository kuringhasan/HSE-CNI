...
<div class="row">
    <div class="col-md-12">        
      ...
      <a id="btn-skks" href="<?php echo $url_cetak;?>/skks/<?php echo $detail->id;?>" class="btn btn-primary btn-xs btn-detail-data" target="_blank" role="1" ><i class="fa fa-print"></i> &nbsp;Preview SKKS</a>
      <a id="btn-surat-keterangan"  href="<?php echo $url_cetak;?>/pskt/<?php echo $detail->id;?>" class="btn btn-primary btn-xs btn-detail-data" target="_blank" role="1" ><i class="fa fa-print"></i> &nbsp;Surat Keterangan</a>
      <a id="btn-rekaman-pelayanan" href="<?php echo $url_cetak;?>/rekam_pelayanan/<?php echo $detail->id;?>" class="btn btn-primary btn-xs btn-detail-data" target="_blank" role="1" ><i class="fa fa-print"></i> &nbsp;Rekaman Pelayanan</a>
      <a id="btn-surat-ambil-dkt" href="<?php echo $url_cetak;?>/skbp/<?php echo $detail->id;?>" class="btn btn-primary btn-xs btn-detail-data" target="_blank" role="1" ><i class="fa fa-print"></i> &nbsp;Surat Pengambilan DKT</a>
      <a id="btn-pemberitahuan" href="" class="btn btn-primary btn-xs btn-detail-data" target="_blank" role="1" ><i class="fa fa-print"></i> &nbsp;Pemberitahuan</a>
      <a id="btn-berita-acara" href="" class="btn btn-primary btn-xs btn-detail-data" target="_blank" role="1" ><i class="fa fa-print"></i> &nbsp;Berita Acara</a>
      <a id="btn-kehilangan" href="" class="btn btn-primary btn-xs btn-detail-data" target="_blank" role="1" ><i class="fa fa-print"></i> &nbsp;Pemeriksaan Kehilangan</a>
      </p>
   </div>
</div>  