...
<form id="form_input_data"  action="<?php echo $url_action; ?>/save" method="post" style="display:inline-block" enctype="multipart/form-data" >
		...
		$(document).ready(function () {
          ...
          <div class="row-form" style="">
               <strong>Berita Acara Final Draugh Survey</strong>
        <input type="hidden" class="input" name="draugh_survey_for[]"  size="2" value="Final Draugh Survey"/>
            </div>
            <div class="row-form" style="text-align:center;">

                <div id="image_preview_parent"><img id="previewing_parent" src="<?php echo $detail->files[0]->url_file;?>" height="250"  /></div>
            </div>

            <div class="row-form" >

            <input type="hidden" class="input" name="pilih_category[]"  size="2" value="shipment"/>
            <input type="hidden" class="input" name="id[]"  size="4" value="<?php echo $detail->id;?>"/>
            <input type="file" name="file_dokumen[]" id="file_foto_parent"  class="input file_foto" size="35"  role="_parent" >



            </div>
            <div class="row-form" >
            <input type="text" class="input" name="pilih_nama_berkas[]"  size="25" placeholder="Nama Berkas" value="<?php echo $detail->files[0]->nama_berkas;?>"/>
            </div>
            <div class="row-form">
            <i>Ukuran : 30 - 500KB</i>
