            ...
            <div class="box-body">
              ...
              <table id="list_data" class="table table-bordered table-hover dataTable"  style="width:100%">
                ...
                <tr>
                  ...
                  <th >Type</th>
                  <th style="width:200px;">Odoo ID</th>
                ...
                <tr>
                  ...
                  <th  style="text-align:center"><select name="search-by-contractor" data-column="4" class="form-control input-xm search-by-contractor" id="search-by-contractor" style="width:100%">
                    <?php
