            ...
            <div class="box-body">
              ...
              <table id="list_data" class="table table-bordered table-hover dataTable"  style="width:100%">
                <thead>
                    ...
                    <th  style="width:130px;">is company?</th>
                    <th  style="width:130px;">is contractor?</th>
                    <th  style="width:130px;">Kode</th>
                    <th  style="width:130px;">Alias</th>
                    <th  style="width:130px;">Alamat</th>

                    <th  style="width:100px;"><?php echo $TombolTambah;?></th>
                    </tr>
...
$j(document).ready(function() {
	...
	var table=$j('#list_data').DataTable( {
            ...
            "columns": [
                ...
                { "data": "name" },
                { "data": "nik" },
                { data: "is_company", 'sortable': false,
                    render: function (data, type, full, meta) {
                      if(data == 1){
                        return '<center><input onclick="return false;" type="checkbox" id="is_company' + data + '" class="check" name="check" checked></center>';
                      }else{
                        return '<center><input onclick="return false;" type="checkbox" id="is_company' + data + '" class="check" name="check" ></center>';
                      }
                  }
                },
                { data: "is_contractor" , 'sortable': false,
                    render: function (data, type, full, meta) {
                      if(data == 1){
                        return '<center><input onclick="return false;" type="checkbox" id="is_contractor' + data + '" class="check" name="check" checked></center>';
                      }else{
                        return '<center><input onclick="return false;" type="checkbox" id="is_contractor' + data + '" class="check" name="check" ></center>';
                      }
                  }
                },
                { "data": "code" },
                { "data": "alias" },
                { "data": "alamat" },
                { "data": "Aksi",'sortable': false,'className':'btn-action' }
            ],
    ...
    $j('#btn-tambah-data').on( 'click', function () {   // for text boxes
        ...
        $j('#largeModal .modal-title').html("Form Input Partner");
    ...
    table.on('click', '.btn-edit-data', function (e) {
		...
		table.on('click', '.btn-detail-data', function (e) {
		  ...
		  $j('#largeModal .modal-title').html("Detail Partner");
			$j('#largeModal .modal-body').load(target, function() {
