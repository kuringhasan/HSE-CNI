            ...
            <div class="box-body">
              ...
              <table id="list_data" class="table table-bordered table-hover dataTable"  style="width:100%">
                ...
                <tr>
                  ...
                  <th style="width:150px;">Block PIT</th>
                  
                  <th  style="width:150px;">Kordinat</th>
                  <th >Area</th>
                ...
                <tr>
                  ...
                  <th  style="text-align:center">&nbsp;</th>
                   <th >
                    <select name="search-by-contractor" data-column="4" class="form-control input-xm search-by-contractor" id="search-by-contractor" style="width:100%">
                          <?php
                   ...
                   <th  style="text-align:center">
                    <select name="search-by-status" data-column="5"  class="input search-by-status" style=";" id="search-by-status">
	...
	var table=$j('#list_data').DataTable( {
		...
		$j('#btn-tambah-data').on( 'click', function () {   // for text boxes
			var target = $j(this).attr('href');
		  	$j('#largeModal .modal-title').html("Form Input PIT");
		...
		table.on('click', '.btn-edit-data', function (e) {
			var target = $j(this).attr('href');
		  	...
		  	$j('#largeModal .modal-title').html("Form Edit PIT");
			$j('#largeModal .modal-body').load(target, function() {
				 $j('#largeModal').modal('show');
			});
			$j('#largeModal .modal-footer').html('');
