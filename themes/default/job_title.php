            ...
            <div class="box-body">
              ...
              <table id="list_data" class="table table-bordered table-hover dataTable"  style="width:100%">
                ...
                <tr>
                  ...
                  <th  >
                  <select name="search-by-classification" data-column="4" class="form-control input-xm search-by-classification" id="search-by-category" style="width:100%">
                          <?php
                  ...
                  <th  > <input type="text" data-column="1"  class="form-control search-by-name" style="width:100%" placeholder="Job title">
                  </th>                  
                  <th  ></th>                  
                  <th  ></th>
                  <th  ></th>
...
var $j = jQuery.noConflict();
  $j(document).ready(function() {
	...
	var table=$j('#list_data').DataTable( {
		...
		$j('.search-by-classification').on( 'keyup click', function () {   // for text boxes
			var i =$j(this).attr('data-column');  // getting column index
			var v =$j(this).val();  // getting search input value
			table.columns(i).search(v).draw();
		} );	
		...
		$j('#btn-tambah-data').on( 'click', function () {   // for text boxes
			var target = $j(this).attr('href');
		  	$j('#largeModal .modal-title').html("Form Input Job Title");
