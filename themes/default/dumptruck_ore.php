         ...
         <table id="list_data" class="table table-bordered table-hover dataTable"  style="width:100%">
            ...
            <tr>
             ...
             <tr>
              <th class="no-form">&nbsp;</th>
              <th ></th>
              <th class="no-form"><select name="search-by-dump" data-column="2" class="form-control input-xm search-by-dump" id="search-by-dump" style="width:100%">
                          <?php
                        echo '<option value="">-- Dump Truck --</option>';
	...
	$j('.select2').select2()
		...
		var table2=$j('#list_data').DataTable({
			...
			//console.log(aData);
				...
				$j( nRow ).find('td:eq(2)').attr('data-label',"name");
				$j( nRow ).find('td:eq(3)').attr('data-label',"Aksi");
			},
			"initComplete": function(settings, json) {
				...
				child.innerHTML = 
						'<select name="cr_company" data-column="3" class="form-control input-xm cr_company" id="cr_company" onChange="pilihcompany(this.value,3,\'cr_company\');" title="Pilih Kontraktor">\n'+
		...
		//table2.removeClass("sorting_asc");
				...
				$j('#search-by-dump').on( 'keyup click', function () {   // for text boxes
				...
				//$j('.btn-detail-data').on( 'click', function () {   // for text boxes
					...
					$j('#largeModal .modal-title').html("Detail Dump Truck Ore");
...
function format ( data ) {
		...
		if (data.Detail.length>0)
		{
			...
			var no=1;
			var html="<div style=\"margin-left:10px;width:100%;\" class=\"media-child\">Ritase :<br /><table  border=\"1\" class=\"list-child table table-bordered dataTable\" style=\"width:auto;border-top:1px;text-align:left;\" ><tr style=\"border-top:1px;\"><th style=\"width:25px;text-align:center;\">No</th><th style=\"width:100px;text-align:left;\">Dump Truck</th><th style=\"width:60px;text-align:center;\">Ritase</th><th style=\"width:60px;text-align:center;\">Qty (Ton)</th></tr>";
