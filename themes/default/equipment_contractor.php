            ...
            <div class="box-body">
              ...
              <table id="list_data" class="table table-bordered table-hover dataTable"  style="width:100%">
                ...
                <tr>
                  ...
                  <th  style="width:120px;">Nomor Body</th>                  
                ...
                <tr>
                  ...
                  <th  >
                  <select name="search-by-category" data-column="4" class="form-control input-xm search-by-category" id="search-by-category" style="width:100%">
                          <?php
