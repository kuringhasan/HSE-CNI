            ...
            <div class="box-body">
              ...
              <table id="list_data" class="table table-bordered table-hover dataTable"  style="width:100%">
                ...
                <tr>
                  ...
                  <input type="text" data-column="0"  class="form-control search-by-nik" style="width:100%" id="search-by-nik"></td>
                 ...
                 <td style="width:25px;padding-top:2px;;padding-bottom:2px;"></td>
                  ...
                  <input type="text" data-column="3"  class="form-control search-by-anggota" style="width:100%" id="search-by-anggota">
                  </td>
                  <td style="padding-top:2px;;padding-bottom:2px;" class="text-center"><span class="text-center" style="padding-top:2px;padding-bottom:2px;">
