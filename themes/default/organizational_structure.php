            ...
            <div class="box-body">
              ...
              <table id="list_data" class="table table-bordered table-hover dataTable"  style="width:100%">
                ...
                <tr>
                  ...
                  <th  style="width:140px;">Organizational Structure</th>                  
                ...
                <tr>
                  ...
                  <th  > <input type="text" data-column="1"  class="form-control search-by-name" style="width:100%" placeholder="Name">
                  </th>                  
                  <th  ></th>                  
                  <th  ></th>
                  <th  ></th>
	...
	var table=$j('#list_data').DataTable( {
		...
		$j('#btn-tambah-data').on( 'click', function () {   // for text boxes
			var target = $j(this).attr('href');
		  	$j('#largeModal .modal-title').html("Form Input Organizational Structure");
