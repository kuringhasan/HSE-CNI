            ...
            <div class="box-body">
              ...
              <table id="list_data" class="table table-bordered table-hover dataTable"  style="width:100%">
                ...
                <tr>
                  ...
                  <th style="width:150px;">Load Factor PIT</th>
                  
                  <th  style="width:150px;">Load Factor Barging</th>
                  <th >Berlaku Mulai</th>
                  <th style="width:200px;">Berlaku Sampai</th>
                  <th style="width:85px;">Closed</th>
                  <th style="width:85px;"><?php echo $TombolTambah?></th>
                </tr>
                </thead>
  ...
  $j(document).ready(function() {
	...
	var table=$j('#list_data').DataTable( {
					...
					"columns": [
						...
						{ "data": "load_factor_expit" },
						{ "data": "load_factor_barging" },
						{ "data": "berlaku_mulai" },
						{ "data": "berlaku_sampai" },
						{ "data": "closed" },
