        ...
        <div class="box-body">
         ...
         <table id="list_data" class="table table-bordered table-hover dataTable"  style="width:100%">
            ...
            <tr>
             ...
             <tr>
              <th class="no-form">&nbsp;</th>
              <th ><input type="text" data-column="1"  class="form-control search-by-bulan" style="width:100%;" id="search-by-no-bulan" placeholder="Bulan"></th>
              <th class="no-form">&nbsp;</th>
              <th class="no-form">&nbsp;</th>
              <th class="no-form">&nbsp;</th>
              <th >
	...
	$j('.select2').select2()
		...
		var table2=$j('#list_data').DataTable({
			...
			console.log(aData);
				...
				$j( nRow ).find('td:eq(2)').attr('data-label',"Ritase");
				$j( nRow ).find('td:eq(3)').attr('data-label',"Quantity");
				$j( nRow ).find('td:eq(4)').attr('data-label',"Target");
				$j( nRow ).find('td:eq(5)').attr('data-label',"Kontraktor");
				$j( nRow ).find('td:eq(6)').attr('data-label',"Aksi");
			},
