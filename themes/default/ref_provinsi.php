            ...
            <div class="box-body">
              ...
              <table id="list_data" class="table table-bordered table-hover dataTable"  style="width:100%">
                <thead>
                    ...
                    <th  style="width:130px;">Kode Provinsi</th>
                ...
                <thead>
                    ...
                    <th ><input type="text" data-column="1"  class="form-control search-by-code" style="width:100%" placeholder="Kode"></th>
                    <th ><input type="text" data-column="2"  class="form-control search-by-name" style="width:100%" placeholder="Nama"></th>
