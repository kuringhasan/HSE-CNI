            ...
            <div class="box-body">
              ...
              <table id="list_data" class="table table-bordered table-hover dataTable"  style="width:100%">
                ...
                <tr>
                  ...
                  <th rowspan="2" style="width:50px;" >Locked</th>
                  </tr>
                <tr>
...
var $j = jQuery.noConflict();
  $j(document).ready(function() {
	...
	var table=$j('#list_data').DataTable( {
					...
					"serverSide": true,
					"ajax": {
						"url": "<?php echo $url_listdata;?>/harian",
						"type": "POST"
					},
					"columnDefs": [
						{ "orderable": false, "targets": [0,2,3,4,5,6,7,12] },
						{"targets": [0,2,3,4,5,6,7,12],"className": "text-center"}
					 ],
					"columns": [
