...
<form action="" method="post" name="form_input_ritase"  id="form_input_ritase">
  ...
  <div class="row-form">
   ...
   <div class="row-form">
       ...
       <div class="row-form" >
          <span class="label">Tujuan Barge  </span>
    ...
    <div class="row-form">
        <span class="label" >Asal <small class="wajib">*</small></span>
     
      <select  class="input" name="asal" id="asal"  style="width:auto"   >
         <option value="">--</option>
           
            <option value="EFO"  <?php echo "EFO"==$detail->eto_efo?"selected":""; ?> >EFO</option>
            <option value="ETO"  <?php echo "ETO"==$detail->eto_efo?"selected":""; ?> >ETO</option>
     ...
     <div class="row-form" id="row_lokasi_dome">
      ...
      <div class="row-form" id="row_dome_id">
          <span class="label">Asal Dome  </span>
          <select name="dome_asal" id="dome_asal" class="input">
			 <?php
