            ...
            <div class="box-body">
              ...
              <table id="list_data" class="table table-bordered table-hover dataTable"  style="width:100%">
                ...
                <tr>
                  <td></td>
                  <td >
                  <input type="text" data-column="0"  class="form-control search-by-imei" style="width:100%;">
                  </td>
                  <td ><input type="text" data-column="1"  class="form-control search-by-name" style="width:100%;"></td>
                  <td >&nbsp;</td>
...
var $j = jQuery.noConflict();
  $j(document).ready(function() {
	...
	var table=$j('#list_data').DataTable( {
		...
		//var v =""; 
		$j('.search-by-imei').on( 'keyup click', function () {   // for text boxes
		...
		$j('#btn-tambah-data').on( 'click', function () {   // for text boxes
			var target = $j(this).attr('href');
		  	$j('#largeModal .modal-title').html("Form Input IMEI");
