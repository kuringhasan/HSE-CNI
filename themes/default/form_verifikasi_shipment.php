...
<form action="" method="post" name="form_input_data"  id="form_input_data" enctype="multipart/form-data">
  ...
  <div class="row-form">
   ...
   <div class="row-form">
    ...
    <div class="row-form">
					...
					$sex=isset($_POST['gender'])?$_POST['gender']:$profil->JENIS_KELAMIN;
					?>
					<label >  
						<input type="radio"  name="gender" value="L"  <?php echo ($sex=="L")?"checked":"";?>  />
							  Laki-Laki</label> 
