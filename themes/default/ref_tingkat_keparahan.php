        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <!-- <h3 class="box-title">Data Kota & Tingkat Keparahan
            ...
            <div class="box-body">
              ...
              <table id="list_data" class="table table-bordered table-hover dataTable"  style="width:100%">
                <thead>
                    ...
                    <th  style="width:130px;">Nama Tingkat Keparahan</th>
...
$j(document).ready(function() {
    ...
    $j('#btn-tambah-data').on( 'click', function () {   // for text boxes
        ...
        $j('#largeModal .modal-title').html("Form Input Tingkat Keparahan");
    ...
    table.on('click', '.btn-detail-data', function (e) {
        ...
        $j('#largeModal .modal-title').html("Detail Tingkat Keparahan");
        $j('#largeModal .modal-body').load(target, function() {
