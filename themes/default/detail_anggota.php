					...
					#data_kepemilikan_sapi tr th{
                      ...
                      <table id="data_kepemilikan_sapi" class="table table-bordered table-striped">
                        ...
                        <tr>
                          ...
                          <th>Eartag</th>
                          <th>Tipe</th>
                          <th style="width:65px;">Laktasi Ke</th>
                        ...
                        <tr>
                          ...
                          <td style="text-align:center;"><?php echo $sapi->tipe_nama;?></td>
                          <td style="text-align:center;"><?php echo $sapi->LaktasiKe;?></td>
                          <td><?php echo $sapi->StatusReproduksi;?></td>
                          <td><?php echo $sapi->StatusLaktasi;?></td>
                          <td style="text-align:center;"><?php echo $sapi->TanggalIdentifikasi['Tanggal'];?></td>
                        </tr>
                        <?php
						$no++;
